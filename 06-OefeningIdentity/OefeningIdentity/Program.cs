...
using OefeningIdentity.Data;
using OefeningIdentity.Helper;
using OefeningIdentity.Models;
using OefeningIdentity.Services;
...
// SQL
builder.Services.AddDbContext<IdentityDbContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("LocalDBConnection")));

builder.Services.AddEndpointsApiExplorer();
builder.Services.AddSwaggerGen();
builder.Services.AddIdentity<CustomUser,IdentityRole>().AddEntityFrameworkStores<IdentityDbContext>();
